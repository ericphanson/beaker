...
# https://github.com/ultralytics/ultralytics/blob/bc507dac58d08d7fe1b6408824e74c65282ee0e9/examples/YOLOv8-ONNXRuntime/main.py
...
class YOLOv8:
    ...
    def letterbox(
        self, img: np.ndarray, new_shape: Tuple[int, int] = (960, 960)
