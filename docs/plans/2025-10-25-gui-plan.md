...
**Example Projects:**
- **Rerun.io** - 3D visualization tool for robotics/ML ([https://rerun.io](https://rerun.io))
  - Screenshot: Complex multi-panel UI with 3D views, timelines, data inspectors
- **Photon** - Rust image processing app ([https://silvia-odwyer.github.io/photon/](https://silvia-odwyer.github.io/photon/))
  - Screenshot: Image editor with filters, real-time preview
- **egui demo** - Official examples ([https://www.egui.rs/#demo](https://www.egui.rs/#demo))
  - Interactive demo showing all widgets and capabilities
...
tokio = { version = "1", features = ["rt-multi-thread"] }  # already in beaker
image = "0.25"                           # already in beaker

# Total added overhead: ~5-10MB
```
